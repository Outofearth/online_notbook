export const EN_US_MESSAGES = {
    ...
    "settings.user_management_description": "List all member accounts, promote or demote roles, and delete members. Deleting a member permanently removes all of their notes, attachments, version history and backups.",
