export const EN_US_MESSAGES = {
    ...
    "api.error.account_disabled": "This account has been suspended by the owner",
    ...
    "settings.decrypt_and_restore": "Decrypt and restore",
    "settings.decrypt_backup": "Decrypt encrypted backup",
    "settings.decrypt_backup_description": "This backup is encrypted with a password. Enter the encryption password to decrypt and restore.",
    "settings.encryption_description": "The encryption key is derived only in your browser — the server never sees it. Use at least 8 characters, ideally mixing upper/lower case letters and numbers.",
    "settings.encryption_mixed_import": "Both encrypted and plain files detected. Only encrypted files will be processed; plain files are skipped this time.",
    "settings.encryption_password": "Encryption password",
    "settings.encryption_password_confirm": "Confirm password",
    "settings.encryption_password_confirm_placeholder": "Type the same password again",
    "settings.encryption_password_mismatch": "The two passwords do not match",
    "settings.encryption_password_placeholder": "Enter at least 8 characters",
    "settings.encryption_password_too_short": "Password must be at least 8 characters",
    "settings.encryption_warning": "⚠ If you forget this password, the encrypted backup cannot be recovered. Please store it safely.",
    "settings.password_strength_0": "Very weak",
    "settings.password_strength_1": "Weak",
    "settings.password_strength_2": "Fair",
    "settings.password_strength_3": "Good",
    "settings.password_strength_4": "Strong",
    "settings.use_password_encryption": "Encrypt the export with a password",
    "settings.user_management": "User management",
    "settings.user_management_description": "Create member accounts, promote or demote roles, reset passwords, and delete members. Deleting a member permanently removes all of their notes, attachments, version history and backups.",
    "settings.user_delete_confirm_title": "Delete member account",
    "settings.user_delete_confirm_description": "Are you sure you want to delete @{username}? This will permanently remove all notes, attachments, version history and backups owned by that member. This cannot be undone.",
    "settings.user_deleted": "Member account deleted",
    "settings.user_delete_failed": "Failed to delete member account",
    "settings.user_role_change_title": "Change user role",
    "settings.user_role_promote_description": "Promote @{username} to owner. Owners can manage all members, toggle registration, and access instance-wide settings.",
    "settings.user_role_demote_description": "Demote @{username} to member. If this is the last owner, the operation will be rejected.",
    "settings.user_role_change_failed": "Failed to change role",
    "settings.user_promoted_to_owner": "Promoted to owner",
    "settings.user_demoted_to_member": "Demoted to member",
    "settings.user_last_seen_at": "Last seen {when}",
    "settings.role_owner": "Owner",
    "settings.role_member": "Member",
    "settings.current_user": "You",
    "settings.promote": "Promote",
    "settings.promote_to_owner": "Promote to owner",
    "settings.demote": "Demote",
    "settings.demote_to_member": "Demote to member",
    "settings.delete_user": "Delete member",
    "settings.owner_cannot_be_deleted": "Owner accounts cannot be deleted",
    "settings.cannot_change_own_role": "Cannot change your own role",
    "settings.cannot_reset_own_password": "Change your own password in the section above",
    "settings.user_managed_by_configuration": "Managed by configuration",
    "settings.user_management_new_user": "New user",
    "settings.user_create_title": "Create member account",
    "settings.user_create_description": "The account is created right away with a generated password that is shown once.",
    "settings.user_create_username_label": "Username",
    "settings.user_create_username_placeholder": "For example: alex",
    "settings.user_create_confirm": "Create",
    "settings.user_created": "Member account created",
    "settings.user_create_failed": "Failed to create the member account",
    "settings.user_reset_password": "Reset password",
    "settings.user_reset_password_confirm_title": "Reset password",
    "settings.user_reset_password_confirm_description": "Generate a new password for @{username}? They will be signed out of every device.",
    "settings.user_password_reset": "Password reset",
    "settings.user_password_reset_failed": "Failed to reset the password",
    "settings.user_password_reveal_title": "New password for @{username}",
    "settings.user_password_reveal_description": "Copy it now. Only a hash is stored, so this password cannot be shown again.",
    "settings.user_password_copy": "Copy",
    "settings.user_password_copy_failed": "Could not copy. Select the password and copy it manually.",
    "settings.user_password_done": "Done",
    "settings.user_suspend": "Suspend account",
    "settings.user_restore": "Restore account",
    "settings.user_suspend_confirm_title": "Suspend account",
    "settings.user_suspend_confirm_description": "Suspend @{username}? They keep every note and will be signed out immediately, but cannot sign in until you restore the account.",
    "settings.user_restore_confirm_title": "Restore account",
    "settings.user_restore_confirm_description": "Restore @{username}? They will be able to sign in again with their existing password.",
    "settings.user_suspended": "Account suspended",
    "settings.user_restored": "Account restored",
    "settings.user_status_change_failed": "Failed to change the account status",
    "settings.user_suspended_badge": "Suspended",
    "settings.cannot_suspend_own_account": "Cannot suspend your own account",
    "settings.confirm": "Confirm",
    "settings.just_now": "just now",
    "settings.minutes_ago": "{n}m ago",
    "settings.hours_ago": "{n}h ago",
    "settings.days_ago": "{n}d ago",
    ...
    "sidebar.import_files": "Import files",
    "sidebar.import_files_here": "Import files here",
    "sidebar.import_url": "Import from URL",
    "sidebar.import_url_here": "Import URL here",
    "sidebar.import_url_prompt": "Enter the URL of the webpage to import:",
    "sidebar.import_url_ok": "Imported '{title}'",
    "sidebar.import_url_failed": "URL import failed",
    "sidebar.import_no_supported_files": "No supported files found. Inkstone accepts .md / .markdown / .txt / .docx files.",
    "sidebar.import_result_ok": "Created {count} notes.",
    "sidebar.import_result_partial": "{created} succeeded, {failed} failed.",
  ...
  "workspace.a_snapshot_is_saved_every_few_minutes_or_after_larger_edits": "A snapshot is saved every few minutes or after larger edits",
    ...
    "workspace.ai_summarize": "AI Summary",
    "workspace.ai_summarize_failed": "AI summary failed",
    "workspace.ai_summarize_result": "AI summary",
    "workspace.ai_diagram": "AI diagram",
    "workspace.ai_diagram_ready": "Diagram inserted into editor",
    "workspace.ai_diagram_failed": "AI diagram generation failed",
    "workspace.ai_chat": "AI Q&A",
    "workspace.ai_chat_desc": "Ask a question about your notes. The AI answers based on your note content and cites the sources.",
    "workspace.ai_chat_placeholder": "Type your question, press Enter to send...",
    "workspace.ai_chat_send": "Send",
    "workspace.ai_chat_sources": "Sources",
