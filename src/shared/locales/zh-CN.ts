...
export const ZH_CN_MESSAGES = {
    ...
    "api.error.account_disabled": "该账号已被管理员停用",
    ...
    "settings.decrypt_and_restore": "解密并恢复",
    "settings.decrypt_backup": "解密加密备份",
    "settings.decrypt_backup_description": "此备份已使用密码加密。请输入加密密码以解密并恢复。",
    "settings.encryption_description": "密钥仅在浏览器内派生，服务器无法获取。密码至少 8 位，建议包含大小写字母和数字。",
    "settings.encryption_mixed_import": "检测到同时包含加密文件和普通文件。将先处理加密文件，普通文件本次不导入。",
    "settings.encryption_password": "加密密码",
    "settings.encryption_password_confirm": "确认密码",
    "settings.encryption_password_confirm_placeholder": "请再次输入相同的密码",
    "settings.encryption_password_mismatch": "两次输入的密码不一致",
    "settings.encryption_password_placeholder": "请输入至少 8 位密码",
    "settings.encryption_password_too_short": "密码长度至少 8 位",
    "settings.encryption_warning": "⚠ 忘记此密码将无法恢复加密备份，请妥善保管。",
    "settings.password_strength_0": "极弱",
    "settings.password_strength_1": "弱",
    "settings.password_strength_2": "一般",
    "settings.password_strength_3": "较好",
    "settings.password_strength_4": "强",
    "settings.use_password_encryption": "使用密码加密导出内容",
    "settings.user_management": "用户管理",
    "settings.user_management_description": "支持新建成员账号、修改角色、重置密码和删除成员。删除成员会连同其全部数据（笔记、附件、备份等）一起清理，操作不可恢复。",
    "settings.user_delete_confirm_title": "删除成员账号",
    "settings.user_delete_confirm_description": "确定要删除成员 @{username} 吗？该成员的全部笔记、附件、版本历史等数据都会被永久删除，此操作无法撤销。",
    "settings.user_deleted": "成员账号已删除",
    "settings.user_delete_failed": "删除成员账号失败",
    "settings.user_role_change_title": "修改用户角色",
    "settings.user_role_promote_description": "将 @{username} 提升为 owner。Owner 可以管理所有成员、开启/关闭注册、以及访问系统级设置。",
    "settings.user_role_demote_description": "将 @{username} 降为 member。如果这是最后一个 owner，操作会被阻止。",
    "settings.user_role_change_failed": "修改角色失败",
    "settings.user_promoted_to_owner": "已提升为 owner",
    "settings.user_demoted_to_member": "已降为 member",
    "settings.user_last_seen_at": "上次活跃 {when}",
    "settings.role_owner": "Owner",
    "settings.role_member": "成员",
    "settings.current_user": "你",
    "settings.promote": "提升",
    "settings.promote_to_owner": "提升为 owner",
    "settings.demote": "降为成员",
    "settings.demote_to_member": "降为 member",
    "settings.delete_user": "删除成员",
    "settings.owner_cannot_be_deleted": "Owner 账号不能被删除",
    "settings.cannot_change_own_role": "不能修改自己的角色",
    "settings.cannot_reset_own_password": "修改自己的密码请使用上方区域",
    "settings.user_managed_by_configuration": "由部署配置管理",
    "settings.user_management_new_user": "新建用户",
    "settings.user_create_title": "新建成员账号",
    "settings.user_create_description": "账号会立即创建，并生成一个只显示一次的密码。",
    "settings.user_create_username_label": "用户名",
    "settings.user_create_username_placeholder": "例如：alex",
    "settings.user_create_confirm": "创建",
    "settings.user_created": "成员账号已创建",
    "settings.user_create_failed": "新建成员账号失败",
    "settings.user_reset_password": "重置密码",
    "settings.user_reset_password_confirm_title": "重置密码",
    "settings.user_reset_password_confirm_description": "为 @{username} 生成新密码？该用户会在所有设备上退出登录。",
    "settings.user_password_reset": "密码已重置",
    "settings.user_password_reset_failed": "重置密码失败",
    "settings.user_password_reveal_title": "@{username} 的新密码",
    "settings.user_password_reveal_description": "请立即复制。服务端只保存哈希，此密码无法再次查看。",
    "settings.user_password_copy": "复制",
    "settings.user_password_copy_failed": "复制失败，请手动选中密码后复制。",
    "settings.user_password_done": "完成",
    "settings.user_suspend": "停用账号",
    "settings.user_restore": "恢复账号",
    "settings.user_suspend_confirm_title": "停用账号",
    "settings.user_suspend_confirm_description": "确定要停用 @{username} 吗？其笔记数据全部保留，但会立即退出登录，且在恢复前无法再次登录。",
    "settings.user_restore_confirm_title": "恢复账号",
    "settings.user_restore_confirm_description": "确定要恢复 @{username} 吗？该账号可继续使用原有密码登录。",
    "settings.user_suspended": "账号已停用",
    "settings.user_restored": "账号已恢复",
    "settings.user_status_change_failed": "修改账号状态失败",
    "settings.user_suspended_badge": "已停用",
    "settings.cannot_suspend_own_account": "不能停用自己的账号",
    "settings.confirm": "确认",
    "settings.just_now": "刚刚",
    "settings.minutes_ago": "{n} 分钟前",
    "settings.hours_ago": "{n} 小时前",
    "settings.days_ago": "{n} 天前",
    ...
    "sidebar.import_files": "导入文件",
    "sidebar.import_files_here": "导入文件到这里",
    "sidebar.import_url": "从网页导入",
    "sidebar.import_url_here": "在这里导入网页",
    "sidebar.import_url_prompt": "请输入要导入的网页 URL：",
    "sidebar.import_url_ok": "已导入「{title}」",
    "sidebar.import_url_failed": "URL 导入失败",
    "sidebar.import_no_supported_files": "未找到支持的文件。可导入 .md / .markdown / .txt / .docx 格式。",
    "sidebar.import_result_ok": "成功创建 {count} 条笔记。",
    "sidebar.import_result_partial": "成功创建 {created} 条，失败 {failed} 条。",
  ...
  "workspace.a_snapshot_is_saved_every_few_minutes_or_after_larger_edits": "每隔几分钟或改动较大时，会自动留一份存档",
    ...
    "workspace.ai_summarize": "AI 总结",
    "workspace.ai_summarize_failed": "AI 总结失败",
    "workspace.ai_summarize_result": "AI 总结",
    "workspace.ai_diagram": "AI 生成图表",
    "workspace.ai_diagram_ready": "图表已插入编辑器",
    "workspace.ai_diagram_failed": "AI 图表生成失败",
    "workspace.ai_chat": "AI 问答",
    "workspace.ai_chat_desc": "向你的笔记库提问，AI 会根据笔记内容回答并标出引用来源。",
    "workspace.ai_chat_placeholder": "输入你的问题，回车发送...",
    "workspace.ai_chat_send": "发送",
    "workspace.ai_chat_sources": "引用来源",
